...
public class IocTest {
    ...
    private static void testSimple() {
        ...
        workLogService.findEmployeeById(10000L);
    ...
    private static void testXmlConfig() {
        try (AbstractApplicationContext factory
            ...
            WorkLogService workLogService2 = factory.getBean("worklog-ctor-injected", WorkLogService.class);

            workLogService2.findEmployeeById(1L);
            workLogService2.findEmployeeById(10000L);
            workLogService2.findAllEmployees();
        }
    }

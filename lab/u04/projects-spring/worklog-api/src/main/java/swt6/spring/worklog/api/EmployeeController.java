...
public class EmployeeController {
    ...
    public List<EmployeeDto> getEmployees() {
        ...
        List<Employee> employees = workLogService.findAllEmployees();
        Type emplListType = (new TypeToken<>() {}).getType();
        List<EmployeeDto> employeeDtos = mapper.map(employees, emplListType);
        return workLogService.findAllEmployees()
                .stream()
